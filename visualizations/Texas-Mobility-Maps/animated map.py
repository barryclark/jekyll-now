...
Counties = geopandas.read_file(
    "Texas_County_Boundaries_Detailed.geojson", index_col="CNTY_NM"
)
...
Counties = Counties.merge(
    countyData, how="left", left_on="County", right_on="sub_region_2"
)
