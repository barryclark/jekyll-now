...
Here you can see an example to understand how Google Dorks can be used by hackers to gain sensitive information from specific websites.
...
We can also use other search filed than URL that will help to uncover a lot of information about a site. Also here, automation is king.

Try: [BullsEye0/dorks-eye](https://github.com/BullsEye0/dorks-eye)
...
"Mecury Version" "Infrastructure Group"
