...
## 컴포넌트
[컴포넌트](https://docs.unrealengine.com/4.26/ko/Basics/Components/)는 액터의 주요 기능으로 크게 세가지로 나눌 수 있습니다. 플레이어에게 어떻게 보여질지 결정하는 시각적 기능, 액터의 이동과 액터들 간의 상호 동작을 어떻게 할 것인지 물리적 기능, 어떻게 움직일 것인지 움직임과 관련된 기능
