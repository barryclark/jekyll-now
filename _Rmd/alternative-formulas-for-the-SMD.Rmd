...
where $r$ is the pooled, within-group sample correlation between the pre-test and the post-test measures (this is approximation that assumes that the pre-test SMD between groups is relatively small). Alternately, if $se_b$ is provided then the scaled standard error could be calculated directly.
