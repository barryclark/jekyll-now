...
Simulation results are summarized across `r unique(params$reps)` replications. The R code for all this [lives here](https://jepusto.github.io/R/PET-PEESE-performance-simulations.R).
