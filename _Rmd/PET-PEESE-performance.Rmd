...
* Each meta-analysis includes a total of $k$ observed studies, with $k = 50$ or $k = 100$. Note that in scenarios with publication bias, more (sometimes many more) than $k$ studies are generated in order to get $k$ observed effects. 
