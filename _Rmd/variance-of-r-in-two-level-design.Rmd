...
$$
\tilde{N} = \frac{[N g_1 k + N - 1]^2}{N g_2 k^2 + 2 N g_1 k + N - 1} \approx \frac{N}{1 + (g_2 - g_1^2)\psi^2},
$$
...
$$
\tilde{N} = \frac{[n(m - 1)k + nm - 1]^2}{n^2 (m - 1) k^2 + 2 n (m - 1)k + nm - 1} \approx \frac{N}{1 + (n - 1) \psi^2},
$$
