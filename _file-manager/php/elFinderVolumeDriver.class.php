...
abstract class elFinderVolumeDriver {
	...
	protected $options = array(
		...
		'disabled'        => array(),
		// regexp or function name to validate new file name FIX (.htaccess upload ) (added .*)
	...
	protected function mimetype($path) {
		...
		if (preg_match('!/x-empty$!', $type)) { /* FIX*/
            // Empty files are either application/x-empty or inode/x-empty.
             $type = 'text/plain';
        }
		...
		elseif($type == 'unknown') /* FIX 2012.12.13 */
		{
			$type = 'text/plain';
		}
