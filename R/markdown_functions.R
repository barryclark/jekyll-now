...
paste0("![_config.yml]({{ site.baseurl}}/images/",x$next_meeting,"_category_plot.tiff)\n"),
...
paste0("![_config.yml]({{ site.baseurl}}/images/",x$next_meeting,"_client_plot.tiff)\n"),
paste0("I worked on ", paste0(nrow(x$project))," projects. My time split amongst them was:\n"),
paste0("![_config.yml]({{ site.baseurl}}/images/",x$next_meeting,"_project_plot.tiff)\n"),
...
paste0("![_config.yml]({{ site.baseurl}}/images/",x$next_meeting,"_weeks_since.tiff)")
,fill = TRUE, sep = "")
  sink()
}
