...
load("../../static/files/PET-PEESE-Simulation-Results.Rdata")
...
Simulation results are summarized across `r unique(params$reps)` replications. The R code for all this [lives here](/R/PET-PEESE-performance-simulations.R). Complete numerical results [live here](/files/PET-PEESE-Simulation-Results.Rdata). Code for creating the graphs below [lives here](/R/PET-PEESE-performance-graphs.R).
...
* [Uniform distribution of studies, maximum sample size of 120](/rmarkdown-libs/figure-html4/more-bias-of-SPET-SPEESE-1.png)
* [More small studies, maximum sample size of 50](/rmarkdown-libs/figure-html4/more-bias-of-SPET-SPEESE-2.png)
* [More small studies, maximum sample size of 120](/rmarkdown-libs/figure-html4/more-bias-of-SPET-SPEESE-3.png)
* [More large studies, maximum sample size of 50](/rmarkdown-libs/figure-html4/more-bias-of-SPET-SPEESE-4.png)
* [More large studies, maximum sample size of 120](/rmarkdown-libs/figure-html4/more-bias-of-SPET-SPEESE-5.png)
...
* [Uniform distribution of studies, maximum sample size of 120](/rmarkdown-libs/figure-html4/more-RMSE-plots-1.png)
* [More small studies, maximum sample size of 50](/rmarkdown-libs/figure-html4/more-RMSE-plots-2.png)
* [More small studies, maximum sample size of 120](/rmarkdown-libs/figure-html4/more-RMSE-plots-3.png)
* [More large studies, maximum sample size of 50](/rmarkdown-libs/figure-html4/more-RMSE-plots-4.png)
* [More large studies, maximum sample size of 120](/rmarkdown-libs/figure-html4/more-RMSE-plots-5.png)
