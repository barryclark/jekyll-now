...
Version 1.0 of the [ARPobservation package](https://cran.r-project.org/web/packages/ARPobservation/) is now available on the Comprehensive R Archive Network. This makes it [even easier to install](/getting-started-with-ARPobservation). Here's the package description:
