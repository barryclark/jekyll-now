...
The thing is, the download numbers are pretty hard to interpret. Beyond knowing that somebody out there is at least _trying_ to use the tools I've made, it's pretty hard to gauge whether 300 or 3000 or 3 million downloads a month is a good usage level. In this post, I'll attempt to put just a little bit of context around these numbers. Emphasis on _little bit_, as I'm not at all satisfied with what I'll show below, but at least it's something beyond four numbers floating in the air. 
...
Here are the weekly download rates for each of my packages and the two comparables, over the past two years. (Note that the vertical scales of the graphs differ.)
