...
- clubSandwich: [<img src = "https://cranlogs.r-pkg.org/badges/last-month/clubSandwich" style="display: inline-block; max-width:100%; max-height:100%;"/>](https://CRAN.R-project.org/package=clubSandwich)
- ARPobservation: [<img src = "https://cranlogs.r-pkg.org/badges/last-month/ARPobservation" style="display: inline-block; max-width:100%;"/>](https://CRAN.R-project.org/package=ARPobservation)
- scdhlm: [<img src = "https://cranlogs.r-pkg.org/badges/last-month/scdhlm" style="display: inline-block; max-width:100%;"/>](https://CRAN.R-project.org/package=scdhlm)
- SingleCaseES: [<img src = "https://cranlogs.r-pkg.org/badges/last-month/SingleCaseES" style="display: inline-block; max-width:100%;"/>](https://CRAN.R-project.org/package=SingleCaseES)
