...
![Fig eqn1]({{ site.baseurl }}/images/20190617-eqns.PNG "Figure eqn1"){:width="500px"}  
...
![Fig eqn2]({{ site.baseurl }}/images/20190617-altDs.PNG "Figure eqn2"){:width="500px"}  
...
![Fig eqn3]({{ site.baseurl }}/images/20190617-alpha.PNG "Figure eqn3"){:width="500px"}  

6. Calculate the zero and pole frequencies using the following equations: 

![Fig eqn4]({{ site.baseurl }}/images/20190617-polezerofreqs.PNG "Figure eqn4"){:width="500px"}  
