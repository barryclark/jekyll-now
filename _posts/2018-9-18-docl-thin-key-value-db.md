---
layout: post
title: Docl, a thin schemaless & key-value database 
---
...
In short, Docl is a schemaless database that stringifies (json format) any object and persist it in a key-value table.
