...
{:.center}
![]( /images/aws-opensearch-kibana-azure-ad/azure-ad-create-ent-app.png){:style="width:70%"}
...
{:.center}
![]( /images/aws-opensearch-kibana-azure-ad/opensearch-saml-config-01.png){:style="width:70%"} 
...
{:.center}
![]( /images/aws-opensearch-kibana-azure-ad/azure-ad-config-access.png){:style="width:70%"} 
