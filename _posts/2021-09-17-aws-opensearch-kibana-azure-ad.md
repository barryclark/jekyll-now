...
{:.center}
![]( /images/aws-opensearch-kibana-azure-ad/azure-ad-create-ent-app-01.png){:style="width:110%"}

![]( /images/aws-opensearch-kibana-azure-ad/azure-ad-create-ent-app-02.png){:style="width:70%"}
...
{:.center}
![]( /images/aws-opensearch-kibana-azure-ad/opensearch-saml-config-01.png){:style="width:100%"} 
...
{:.center}
![]( /images/aws-opensearch-kibana-azure-ad/azure-ad-saml-config-00.png){:style="width:100%"} 
...
{:.center}
![]( /images/aws-opensearch-kibana-azure-ad/azure-ad-config-access.png){:style="width:100%"} 
...
{:.center}
![]( /images/aws-opensearch-kibana-azure-ad/azure-ad-config-claims-00.png){:style="width:100%"}

{:.center}
![]( /images/aws-opensearch-kibana-azure-ad/azure-ad-config-claims.png){:style="width:70%"}
...
{:.center}
![]( /images/aws-opensearch-kibana-azure-ad/opensearch-optional-saml.png){:style="width:100%"}
...
{:.center}
![]( /images/aws-opensearch-kibana-azure-ad/opensearch-security.png){:style="width:70%"}

{:.center}
![]( /images/aws-opensearch-kibana-azure-ad/opensearch-roles.png){:style="width:70%"}

{:.center}
![]( /images/aws-opensearch-kibana-azure-ad/opensearch-roles-mapping.png){:style="width:120%"}
