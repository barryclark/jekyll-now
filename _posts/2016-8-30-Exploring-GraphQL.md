...
## Getting Started
Note: The full code for this tutorial is available here: https://github.com/rohan-varma/pokemongo-graphQL. If you want to see the code running in action, I recommend you to take a moment to set it up. 
