...
I will update these charts periodically with new data. **Last update: August 17th**

***

### August 17th thoughts & takeaways:

* This update is only for adding the volume projections graphic. Don't take the projections super seriously. 

* Currently, the model only is seeing the reported (or projected) COVID-19 deaths and the day of the week. Currently, a 3rd degree polynomial provides the best fit for the data.
