...
I will update these charts periodically with new data. **Last update: June 26th**
...
* I've added some new data from TSA checkpoints. The data is updated every couple weeks. It'll be interesting to watch to see if the Austin share of USA traffic will start to nosedive with the increase in cases.  
