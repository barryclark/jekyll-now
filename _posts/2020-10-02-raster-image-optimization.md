...
### Learning Objectives
1. Distinguish between lossless, lossy and vector image formats.
2. Optimize an image file size using [Squoosh.app](https://squoosh.app/).
3. Download the optmized image and use it as an asset in a project web page of your choice.
...
## 2. Supporting alternate image formats with the `picture` element
