...
그리고, 죄송한 말씀이지만 다소 불친절한 설명이 포함되어 있습니다. 상세 내용에 대해서 모두 작성하기에는 무리가 있었습니다. 
...
아...........불친절한 설명 죄송합니다...레퍼런스 자료를 참고하시면 도움이 되실것 같습니다.
...
> 처음부터 1.2.0.RELEASE 버전을 검토 했으면 좋았을 것을.............ㅠㅠ 바보; 어쨋든 현재 서비스에 영향을 최소화하고 싶어서 부트 버전 업그레이드를 주저했었습니다.
