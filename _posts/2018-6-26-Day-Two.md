...
The first exercise, after learning the set-up code required to run this program in the terminal, was to learn how to produce an image. The default image that running the code gave was Figure One below:
