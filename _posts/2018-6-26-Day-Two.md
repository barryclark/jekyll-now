...
The first exercise, after learning the set-up code required to run this program in the terminal, was to learn how to produce an image. The default image that running the code gave was [this]({thom-ory.github.io}}/images/Figure_1.png "Figure One"), Figure One
