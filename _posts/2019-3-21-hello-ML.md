...
Training. I will define a train method which will use the classifier's fit method to train, and will output an accuracy score. The will experiment with various classifiers.
