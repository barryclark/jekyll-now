...
In case you only have one dataset, you can manually aplit it in two, or use 
```
...
##### Step 2 - creating a train function
...
Classification can be made in various ways with equally fancy names. One comparation can be found on [scikit](https://scikit-learn.org/stable/auto_examples/classification/plot_classifier_comparison.html) and looks like 
