...
keywords: "machine learning, multinomial Bayes, Naive Bayes, classisication, text"
---
...
```
`TfidVectorizer` is a way of words extraction which gives an importance rating to words discovered in the texts. See [tf-idf](https://en.wikipedia.org/wiki/Tf%E2%80%93idf) for detailed explanation.
