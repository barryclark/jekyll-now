...
For checking if domain name <code>CNAME</code> is succeessfully updated simply type <code>nslookup <domain name address with www in front></code> in Terminal. <code>CNAM</code> was updated when returned result showed appropriate canonical name in Terminal. Enjoy seeing your GitHub site on your own domain name!
