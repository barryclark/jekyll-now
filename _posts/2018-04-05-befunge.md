...
* [BefBef](https://de.wikipedia.org/wiki/Befunge?oldformat=true#Conways_Game_of_Life), a befunge interpreter which is written in befunge. The "program space" of which is being interpreted is actually a subset of the interpreters "program space". Really awesome!
