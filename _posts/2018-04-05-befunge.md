...
* [BefBef](https://www.wikiwand.com/de/Befunge#/BefBef), a befunge interpreter which is written in befunge. The "program space" of which is being interpreted is actually a subset of the interpreters "program space". Really awesome!
* [Conway's Game of Life](https://www.wikiwand.com/de/Befunge#/Conways_Game_of_Life), because a programming language isn't complete without an implementation of the [Game of Life](https://www.wikiwand.com/en/Conway%27s_Game_of_Life).
