...
The chart below plots the annual rate (per 100,000 residents) of fatal crashes, fatalities, crashes in which incapacitating injuries occurred, incapacitating injuries, and total crashes, for each of the six cities. The 2015 numbers are based on a back-of-the-envelope projection (just multiplying the total as of July 31 by 12/7). Notes and sources are at the end of the post. If you prefer the un-standardized numbers, a version of the chart using the raw totals instead of standardizing by population [can be seen here](http://blogs.edb.utexas.edu/pusto/files/2015/08/crash_by_city-2.png).



![plot of chunk crash_by_city]({{site.url}}/figure/Crashes-by-city/crash_by_city-1.png) ![plot of chunk crash_by_city]({{site.url}}/figure/Crashes-by-city/crash_by_city-2.png) 
...
![plot of chunk fatality_rate_by_city]({{site.url}}/figure/Crashes-by-city/fatality_rate_by_city-1.png) 
...
* The underlying crash data (drawing from both the annual reports and the CRIS database) are [available here](http://blogs.edb.utexas.edu/pusto/files/2015/08/Yearly_crash_data_by_city.csv). 
