...
## Ce que j'ai fait :
- lire le chapitre 1 du <a href="https://www.defenseurdesdroits.fr/sites/default/files/atoms/files/guide_-_emploi_des_personnes_en_situation_de_handicap_et_amenagement_raisonnable.pdf">Guide de l'emploi des personnes en situation de handicap et aménagement raisonnable{% include external-icon.html %}</a> du Défenseur des droits
- lire l'article <a href="https://koena.net/decret-rgaa-2019-v1-charges-disproportionnees/">Décret RGAA (1/3) : charges disproportionnées{% include external-icon.html %}</a> de Koena
- lire l'article <a href="https://access42.net/mise-a-jour-rgaa-4-charge-disproportionnee-derogations?lang=fr">Mise à jour du RGAA, 3ème partie : comment le décret interprète la notion de charge disproportionnée{% include external-icon.html %}</a> d'Access42
- lire l'<a href="https://cnnumerique.fr/files/uploads/2019/Avis_CNNum_accessibilite_numerique.pdf">Avis du Conseil national du numérique sur le projet de décret relatif à l’accessibilité aux personnes handicapées des services de communication au public en ligne{% include external-icon.html %}</a>

## Ce que j'ai appris
### Aménagement raisonnable
La <a href="https://www.un.org/development/desa/disabilities-fr/la-convention-en-bref-2/texte-integral-de-la-convention-relative-aux-droits-des-personnes-handicapees-13.html">Convention relative aux droits des personnes handicapées des Nations unies{% include external-icon.html %}</a> interdit toutes les discriminations fondées sur le handicap. Selon l'article 2 de la CIDPH :
...
La notion de "charge disproportionnée" est essentielle pour définir les limites de l'obligation d'aménagement raisonnable. La <a href="https://eur-lex.europa.eu/legal-content/FR/TXT/HTML/?uri=CELEX:32016L2102&from=FR#d1e878-1-1">directive européenne de septembre 2016 sur l'accessibilité{% include external-icon.html %}</a> donne la définition suivante :
