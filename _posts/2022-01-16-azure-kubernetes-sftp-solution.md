...
author: Ryan
layout: post
guid: 'https://geekyryan.com/?p=336'
permalink: '/?p=336'
...
<span class="ez-toc-title-toggle"></span></div><nav>- [Next, we will deploy a configMap:](https://geekyryan.com/?p=336/#Next_we_will_deploy_a_configMap "Next, we will deploy a configMap:")
- [Now we need to create our persistent volume claim (PVC)](https://geekyryan.com/?p=336/#Now_we_need_to_create_our_persistent_volume_claim_PVC "Now we need to create our persistent volume claim (PVC)")
- [Now we’ll deploy the replicaSet](https://geekyryan.com/?p=336/#Now_well_deploy_the_replicaSet "Now we’ll deploy the replicaSet")
- [Finally, we need to deploy the service](https://geekyryan.com/?p=336/#Finally_we_need_to_deploy_the_service "Finally, we need to deploy the service")

</nav></div>## <span class="ez-toc-section" id="Next_we_will_deploy_a_configMap"></span>Next, we will deploy a configMap:<span class="ez-toc-section-end"></span>
...
## <span class="ez-toc-section" id="Now_we_need_to_create_our_persistent_volume_claim_PVC"></span>Now we need to create our persistent volume claim (PVC)<span class="ez-toc-section-end"></span>
...
## <span class="ez-toc-section" id="Now_well_deploy_the_replicaSet"></span>Now we’ll deploy the replicaSet<span class="ez-toc-section-end"></span>
...
## <span class="ez-toc-section" id="Finally_we_need_to_deploy_the_service"></span>Finally, we need to deploy the service<span class="ez-toc-section-end"></span>
