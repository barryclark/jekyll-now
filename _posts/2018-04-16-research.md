...
Data science research moves quickly, and you'll soon be left behind if you don't keep up with the newest research happening in the field. Although you'll (hopefully) do some literature review when starting a data science project at work, you may miss out on an interesting avenue to go down to solve a problem without the background knowledge that such a new methodology or model exists.
