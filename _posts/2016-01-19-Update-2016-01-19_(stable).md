...
We are happy to announce our default kernel for Manjaro Bellatrix and Capella are patched against the Zero-Day Linux Kernel Vulnerability.
We recommend to upgrade to that kernel as soon as possible. Our other kernel series will follow. Tips and more information about this issue can be gained from our [bugtracker](https://github.com/manjaro/packages-core/issues/28) and from our [manjaro-security](https://lists.manjaro.org/pipermail/manjaro-security/2016-January/000038.html) mailing list.
