...
![_config.yml]({{ site.baseurl }}/images/stop_and_frisk/sf_header.png)
...
![_config.yml]({{ site.baseurl }}/images/stop_and_frisk/01_monthly_sf.png)
![](https://raw.githubusercontent.com/GWarrenn/gwarrenn.github.io/master/images/stop_and_frisk/01_monthly_sf.png)
...
![_config.yml]({{ site.baseurl }}/images/stop_and_frisk/02_time_of_day_sf.png)
![](https://raw.githubusercontent.com/GWarrenn/gwarrenn.github.io/master/images/stop_and_frisk/02_time_of_day_sf.png)
...
![_config.yml]({{ site.baseurl }}/images/stop_and_frisk/03_census_sf_race.png)
![](https://raw.githubusercontent.com/GWarrenn/gwarrenn.github.io/master/images/stop_and_frisk/03_census_sf_race.png)
...
![_config.yml]({{ site.baseurl }}/images/stop_and_frisk/gender_race_contact.png)
...
![_config.yml]({{ site.baseurl }}/images/stop_and_frisk/reason_for_stop.png)
![](https://raw.githubusercontent.com/GWarrenn/gwarrenn.github.io/master/images/stop_and_frisk/reason_for_stop.png)
...
![_config.yml]({{ site.baseurl }}/images/stop_and_frisk/04_sf_age_dist.png)
![](https://raw.githubusercontent.com/GWarrenn/gwarrenn.github.io/master/images/stop_and_frisk/04_sf_age_dist.png)
...
![_config.yml]({{ site.baseurl }}/images/stop_and_frisk/05_nbh_sf.gif)
...
![_config.yml]({{ site.baseurl }}/images/stop_and_frisk/06_nbh_sf_race.png)
...
![_config.yml]({{ site.baseurl }}/images/stop_and_frisk/07_nbh_diff_black.png)
...
![_config.yml]({{ site.baseurl }}/images/stop_and_frisk/08_crime_frisks.png)
![](https://raw.githubusercontent.com/GWarrenn/gwarrenn.github.io/master/images/stop_and_frisk/08_crime_frisks.png)

Throughout this section it's important to keep the words of [Hadley Wickham](https://github.com/hadley/r4ds/blob/master/model-basics.Rmd) in mind: 
...
![_config.yml]({{ site.baseurl }}/images/stop_and_frisk/09_crime_model_residuals.png)
...
![_config.yml]({{ site.baseurl }}/images/stop_and_frisk/10_sf_arrests_nbh_race.png)
![](https://raw.githubusercontent.com/GWarrenn/gwarrenn.github.io/master/images/stop_and_frisk/10_sf_arrests_nbh_race.png)
...
![_config.yml]({{ site.baseurl }}/images/stop_and_frisk/11_nbh_crime_sf_race_scatter.png)
...
![_config.yml]({{ site.baseurl }}/images/stop_and_frisk/12_nbh_diff_crimes.png)
...
![_config.yml]({{ site.baseurl }}/images/stop_and_frisk/13_poisson_plot.png)
...
All of the code used for this project can be found here: (https://github.com/GWarrenn/dc_data/tree/master/03_stop_frisk) and all of the data can be accessed through the DC OpenData Portal.
