...
Despite being required by the NEAR Act, the MPD has failed to collect and report the detailed stop and frisk data since 2016. This data includes critical information that demonstrates the basis of the stop and frisk incident, including what grounds led to the stop and whether an arrest was made. 
