...
For a long time ZotBins has taken a educational approach, where we try to educate users in how to recycle/compost more and waste less. However, sometimes, this doesn't lead to significant behavioral changes to actually increase recycling and composting rates. This is actually a common problem that Katie Patrick likes to call the **Value-Action Gap**. She states that scientific studies show educating people on important environmental topics contributed to mainly peoples' environmental values, but doesn't necessarily translate into action. That means that yes, they cared about environmental issues more, but didn't necessarily do anything about it.
