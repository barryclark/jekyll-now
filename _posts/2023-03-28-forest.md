...
I used hashcat and since it was relatively easy to crack with rockyou.txt I just continued with my VM. If it was more difficult I would have switched over to my main system. It is not recommended to use hashcat on your VM as it can be very slow.
