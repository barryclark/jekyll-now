...
This port is relatively easy to enumerate and can generate a lot of useful information if anonymous access is allowed which it is. We confirm the users we have but more imortantly there is one more that wasn't in our ldap enumeration. **svc-alfresco**!
