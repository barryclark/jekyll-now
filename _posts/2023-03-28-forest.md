...
This machine that is a good introduction to windows Active Directory enumeration. It is distinct in that it doesn't contain a web server. I start off with an nmap scan to see which ports are open and what services are running. My prefered method for CTFs is
