...
This fine looking gentleman is villain in a video game. Dr. Venom appears in the intro cinematic of Nemsis 2, a 1987 video game. This image in particular comes at a dramatic reveal in the cinematic.
...
The road to this image how,ever goes through generating over 30 images and tweaking prompts. The first kind of prompt I'd use is something like:
...
## MidJourney
The results of Midjourney has always stood out as especially beautiful. I tried it with the original prompt containing only the subject. The result were amazing.
...
* They have an API and so the models can be access programmatically. A key point for extending the capability and building more advanced systems that use an image generation comonent.
...
* The fact that Stable Diffusion is open source is another big point in their favor. The managed model can be used as a protytyping ground (or a production tool for certain use cases) yet you have the knowledge that if your use cases requires fine-tuning your own model you can revert to the open source versions.
...
* Dream Studio still does not use robustly keep a history of all the images the user generates.
...
This is a good place to end this post although there a bunch of other topics I had wanted to address. Let me know what you think on <a href="https://twitter.com/JayAlammar">@JayAlammar</a> or <a href="https://sigmoid.social/@JayAlammar">@JayAlammar@sigmoid.social</a>.
