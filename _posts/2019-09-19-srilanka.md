...
description: A blog post about our three and a half weeks travelling in Sri Lanka in June 2019
---

This blog post shares some of my and Dan's experiences and highlights travelling in Sri Lanka for three and a half weeks in June 2019.
...
The map below shows our route around Sri Lanka (anti-clockwise from Colombo). We enjoyed all the transport options including private driver ([Nisha was excellent][4]), taxi, tuk tuk, train, public and private buses.

![]({{"/images/srilanka/srilanka-map.png"|absolute_url}})
...
![]({{"/images/srilanka/kandy2.png"|absolute_url}})
...
![]({{"/images/srilanka/adamspeak1.png"|absolute_url}})
...
![]({{"/images/srilanka/train1.png"|absolute_url}})

![]({{"/images/srilanka/train2.png"|absolute_url}})
...
![]({{"/images/srilanka/ella2.png"|absolute_url}})

![]({{"/images/srilanka/ella1.png"|absolute_url}})
...
![]({{"/images/srilanka/udawalawe1.png"|absolute_url}})

![]({{"/images/srilanka/udawalawe.png"|absolute_url}})

![]({{"/images/srilanka/Udawalawebuf.png"|absolute_url}})
...
- Our host here (at [Yala Peace Cottages][1]) was a friendly, outgoing man called Manju, who welcomed us with a Papaya Juice while keeping one eye on the Sri Lanka vs Australia cricket match on in the background.
...
![]({{"/images/srilanka/yalacooking.png"|absolute_url}})

![]({{"/images/srilanka/yalaleopard.png"|absolute_url}})
![]({{"/images/srilanka/yalaelephants.png"|absolute_url}})
![]({{"/images/srilanka/yaladeer.jpg"|absolute_url}})
![]({{"/images/srilanka/yalamonkeys.png"|absolute_url}})
![]({{"/images/srilanka/yalaelephant1.png"|absolute_url}})
...
- We had a great local instructor, [Dulip from Excellent Surf School][6], who showed as the good spots and helped us get into action quickly.
...
![]({{"/images/srilanka/ABsurf.png"|absolute_url}})

![]({{"/images/srilanka/ABdansurf.png"|absolute_url}})

![]({{"/images/srilanka/ABsurfamy.png"|absolute_url}})

![]({{"/images/srilanka/AB1.png"|absolute_url}})
...
- We found an [excellent guesthouse][3], run by an elderly couple and their three (adult) children, at the recommendation of a friendly beach front restaurant owner.
...
![]({{"/images/srilanka/Nilaveli.png"|absolute_url}})

![]({{"/images/srilanka/nilavali1.png"|absolute_url}})
...
![]({{"/images/srilanka/Jaffna.png"|absolute_url}})

![]({{"/images/srilanka/jaffna3.png"|absolute_url}})

![]({{"/images/srilanka/jaffnadan.png"|absolute_url}})
...
- We really enjoyed our guest house by the lake here too ([Heritage Lake View][2]). Dinner and breakfast were SO GOOD.

![]({{"/images/srilanka/anaratmonkey.png"|absolute_url}})

![]({{"/images/srilanka/anaratancient.png"|absolute_url}})

![]({{"/images/srilanka/anaratbrekky.png"|absolute_url}})
...
![]({{"/images/srilanka/sigiriya.png"|absolute_url}})

![]({{"/images/srilanka/sigiriya1.png"|absolute_url}})

![]({{"/images/srilanka/sigiriya2.png"|absolute_url}})

![]({{"/images/srilanka/bus.png"|absolute_url}})
...
To ensure we had a consistent clean water source without relying on bottled water going forward, in Sri Lanka we pre-ordered some [“Travel Tap” water purifying systems][5] from Amazon. We are happy that we now have water purifying bottles for our travels! So good to be able to drink from any tap (or stream, lake etc) safely and not buy bottled water/create mountains of plastic bottle waste.
...
![]({{"/images/srilanka/water.png"|absolute_url}})

[1]: https://www.tripadvisor.com.au/Hotel_Review-g1102395-d10499062-Reviews-Yala_Peace_Cottages-Tissamaharama_Southern_Province.html
[2]: https://www.lonelyplanet.com/sri-lanka/anuradhapura/hotels/heritage-lake-view/a/lod/59b12a09-7036-425c-9ca8-cf4e4ea55180/357449
[3]: https://www.tripadvisor.com.au/Hotel_Review-g2424710-d6866663-Reviews-Sea_Zone_Hotel-Nilaveli_Eastern_Province.html
[4]: https://www.tripadvisor.com.ph/Attraction_Review-g1102395-d17328593-Reviews-Sri_Lankan_Nisha_Tours-Tissamaharama_Southern_Province.html
[5]: https://www.amazon.co.uk/Travel-Spout-800ml-filter-bottle/dp/B006RGLHOY
[6]: https://www.tripadvisor.com.au/Attraction_Review-g3348959-d7949415-Reviews-Excellent_Surf_School-Arugam_Bay_Eastern_Province.html
[7]: https://restlessbean.home.blog/2019/05/20/sri-lanka-colombo/amp/
[8]: https://globalhobo.com.au/2015/10/22/i-was-kinda-scammed-in-sri-lanka/