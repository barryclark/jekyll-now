...
전문가와 ㅈ문가의 차이
https://www.youtube.com/watch?v=yiG0nOK7woU
...
- VR을 만들 때 피치가 회전하면 굉장히 어지러움을 느낀다고 합니다.
...
- [Unreal] 언리얼로 Google Play 결제 시스템 이용하기 - https://algorfati.tistory.com/91
...
* SVN을 이용하고, 코드 머지가 안될 떄, 싱글톤을 이용해 작성하면, 두 개발자가 새로운 변경사항에 대해 싱글톤 클래스를 변경했을 때, 커밋시 해당 싱글톤 클래스가 충돌하게 됩니다.
...
* Battle은 공격하는 부대와 전략, 방어하는 부대와 전략, 전장으로 부터 결과를 받는 개체입니다.
* BattleField는 전장에 대한 정보를 가지고 있는 개체입니다. 병사의 능력을 조정합니다. 예를 들어 진흑 위에서는 병사의 속도를 감소시킵니다. 또는 협곡의 경우, 전투에서 활약할 수 있는 병사의 수가 감소합니다.
* TrropBattle은 부대에 대한 정보를 가지고 있습니다. 여기에는 병사에 대한 정보를 가지고 있습니다.
* Strategy는 부대의 능력을 보정하는 역할을 합니다. 예를 들어 총공격의 경우, 방어에 취약하지만 공격은 강해지는 것을 들 수 있습니다.

전투에 사용되는 부대의 능력치는 다음과 같이 계산됩니다.

1. (보정된 병사 능력) = (전장 보정) * (병사 능력)
2. (부대 능력) = (병사 수) * (보정된 병사 능력)
3. (보정된 부대 능력) = (전략 보정) * (부대 능력)

**전투 피해 계산**

1. 부대의 총 공격력을 구합니다.
2. 부대의 앞부터 총 공격력의 피해를 계산하여 적용시킵니다.
3. 나머지 값은 내림으로 계산됩니다.
