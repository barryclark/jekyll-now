...
If you would like to provide input or comments on this direction, please send email to *feedback@javaee.groups.io*. We will keep you updated as we explore this approach in more detail.

For more information about how this affects WebLogic Server, see [here](https://blogs.oracle.com/weblogicserver/weblogic-server-and-opening-up-java-ee).
...
*Originaly posted on [The Aquarium](https://blogs.oracle.com/theaquarium/https://blogs.oracle.com/theaquarium/opening-up-ee)*.
