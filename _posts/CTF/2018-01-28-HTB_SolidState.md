...
![Python JAMES](/images/solidstate/script_james "Python JAMES")
Now that our script has executed, we need to setup a netcat listerner
![NC -lvp 1234](/images/solidstate/nc_lvp "Netcat lvp")
After we have executed the script, ssh into the box with mindy using the following command:
![SSH Mindy](/images/solidstate/ssh_login_mindy "SSH Login as Mindy")
...
![NC Connected](/images/solidstates/ssh_connected "SSH Connected")
