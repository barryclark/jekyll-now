...
Your presentation should be tailored around your audience. Try to think about who it is you are talking to. The audidence can span from colleagues, students, and the greater community. You should communicate in a way that your current audience can understand. Try to avoid using jargon or technical language with laypeople. 
Also, do not reuse the same presentation that you presented for a specific audience to a different audience. Your audience do not want to feel lost or unintelligent during your presentation. 

## Tip #2: Words, words, words.
Do not have slides filled with words. Oftentimes, audience members can get lost in a sea of words. I heard an anectdote where an audience member told the presenter that their talk was distracting the audience from reading the slides.
...
_In medias res_ storytelling is when you start your presentation in the middle of the story, preferably somehwere interesting, before returning to the beginning to explain how you came to be that point. 
...
## Tip #7: Figures
Oftentimes, people re-use their figures from articles for presentations. This doesn't always work because figures in articles are typically dense with extensive captions that readers can take their time to digest. Presentation figures need to be simpler and easy to interpret. 

## Tip #8: Timing
Bear in mind how much you time have. Audience members can tell when you are rushing, which distracts from the presentation and can cause you to not communicate your message properly. Speak at a steady pace and if you feel nervous, take a breath, and then continue.

## Tip #8: Animations
Recent software have really enabled interactive presentations using animations. While animations can definitely enhance your presentation, it can also distract from it. Try not to have a blank slide where you appear text or figures. It is awkward to look at blank slide and even more awkward presenting with one. Unless you really need bullet points to appear one by one, it is better to have them all appear together. This way you do not forget to click for it to appear while you speak.
