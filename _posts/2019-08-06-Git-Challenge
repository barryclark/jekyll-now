...
Recently I had a challenge in the version control of a project.
...
Narrator: "They wouldn't merge it all at the end of the Sprint".
...
- We have dozens of developers committing to the master (and some others on the feature branch).
...
As an extra step, before pushing everything, I merged the master to the feature branch. And NO CONFLICTS WITH THE WORKLOAD WERE FOUND. Just some conflicts with the commits not included on the bundle. Again, EXPECTED.
