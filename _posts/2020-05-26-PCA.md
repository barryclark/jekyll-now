...
To get started, make sure you have installed both [R](https://www.r-project.org/) and [RStudio](https://rstudio.com/) in addition to the packages listed below. If you need help getting started with R, I suggest [DataCamp](https://www.datacamp.com/courses/free-introduction-to-r) in addition to other resources found online.
