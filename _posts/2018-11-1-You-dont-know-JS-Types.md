---
layout: post
title: Вы не знаете JS. Типы и грамматика. Глава 2. Типы.
images:
...
Перевод Главы 2 книги Кайла Симпсона "Вы не знаете JS. Типы данных и грамматика". 
Этот перевод можно также читать на [{% assign image = page.images[1] %}{% include image.html image=image %}]( https://github.com/azat-io/you-dont-know-js-ru). 
