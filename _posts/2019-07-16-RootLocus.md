...
**Figure 1**
2. **The root locus plots the all the points that are solutions of the closed loop transfer function.** We can write the CL TF equation in 3 ways but they all mean the same thing: ![Fig eqn1]({{ site.baseurl }}/images/2019-07-16-RootLocus/eqn1.png "Figure eqn1"){:width="250px"}  
...
![Fig eqn2]({{ site.baseurl }}/images/eqn2.png "Figure eqn2"){:width="250px"}  
...
Zeros: -2, where M = 1
Notice that this means that, although N = 3 branches will start at the poles of L(s), only M = 1 branch will terminate at a zero. The other 2 branches will go to infinity. This rule comes from looking at the minimum and maximum values of K in the equation a(s) + Kb(s) = 0. When K = 0, then a(s) must also be 0, and so a(s) takes on the values of the poles of L(s), because L(s) = b(s) / a(s). Therefore the root locus starts (when K = 0) at the poles of L(s). When K goes to infinity, then either b(s) = 0 (in which case the root locus arrives at the zeros of L(s)) or s must go to infinity (which is what happens to the branches of the root locus that do not terminate at the zeros). I have drawn the root locus showing the poles and zeros on the s-plane to get us started. 
![Fig 2]({{ site.baseurl }}/images/R1.jpg "Figure 2"){:width="500px"}  
**Figure 2**
...
![Fig 3]({{ site.baseurl }}/images/R2_rlocus.jpg "Figure 3"){:width="500px"}  
**Figure 3**
...
![Fig 4]({{ site.baseurl }}/images/R2.jpg "Figure 4"){:width="500px"}  
**Figure 4**
...
![Fig eqn3]({{ site.baseurl }}/images/eqn3.png "Figure eqn3"){:width="250px"}  
![Fig 5]({{ site.baseurl }}/images/R3.jpg "Figure 5"){:width="500px"}  
**Figure 5**
