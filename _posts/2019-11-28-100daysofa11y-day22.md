...
- lire la <a href="https://www.accede-web.com/notices/html-css-javascript/1-structure/1-8-hierarchie-titres-logique-h1-h6/">notice "Mettre en place une hiérarchie de titres logique et exhaustive avec les balises <h1> à <h6>"{% include external-icon.html %}</a> d'Accedeweb
...
Le Référention Général d'Amélioration de l'Accessibilité (RGAA) pose le critère suivant :
