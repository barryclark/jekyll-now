...
Así pues, haciendo uso del script [publishMessageToRaspiBot.sh](/scripts/publishMessageToRaspiBot.sh), seteando las variables `CHAT_ID` 
...
![Ejemplo de notificación enviada a Telegram](/images/example_notification_to_telegram.png)
