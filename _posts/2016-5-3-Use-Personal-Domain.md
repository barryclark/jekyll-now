...
After registered for a domain name and verified my contact information, the domain name is up and ready. Redirecting my GitHub site to my own domain name was quite straight forward. This [site](https://help.github.com/articles/using-a-custom-domain-with-github-pages/) provides good documentation on how to accomplished this. 
