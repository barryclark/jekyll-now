...
active:     Yes
summary:    Operations dashboard for ArcGIS of COVID-19 situation in Maine using ArcGIS API for Python to publish data from Maine CDC as feature services
...
![covid](https://i.imgur.com/erAFFQa.png)
