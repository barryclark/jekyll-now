...
![_config.yml]({{ site.baseurl}}/images/2019-3-18_category_plot.tiff)

Within each of these categories, I have worked with 9 clients. Split across these clients my last two weeks looked like:

![_config.yml]({{ site.baseurl}}/images/2019-3-18_client_plot.tiff)

I worked on 15 projects. My time split amongst them was:

![_config.yml]({{ site.baseurl}}/images/2019-3-18_project_plot.tiff)
...
![_config.yml]({{ site.baseurl}}/images/2019-3-18_weeks_since.tiff)
