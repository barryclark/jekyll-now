...
//]]></script>
  ...
  <meta name="google-site-verification" content="ki_YurEB8dAr4nrolLctklX_-5X5ynlmvFRCZZ2_4Pc" />
...
.svg-wrapper:hover #shape {
  ...
  <style>
    .left-slide {display:inline-block; position:relative; color:#000000}
...
.left-slide:hover:after {width:100%; background:#191970}
.right-slide {display:inline-block; position:relative; color:#000000}
...
.right-slide:hover:after {width:100%; background:#FF0000}
  </style>
  <style>
    .post-body a::before {content:attr(href); float:none; clear:both; text-transform:none; padding:12px 5%; background:#069; color:#fff; font-family:monospace; font-size:14px; position:fixed; opacity:0; left:0; top:0; visibility:hidden; transform:scaleY(0); text-overflow:ellipsis; overflow:hidden; text-align:center; width:100%; transition:.2s ease-in-out; z-index:99999; margin: 0 auto}
.post-body a:hover::before {opacity:1; visibility:visible; transform:scaleY(1)}
  </style>
  <style>
...
@-webkit-keyframes pulse {from{-webkit-transform:scale3d(0.069,0.069,0.069); transform:scale3d(0.069,0.069,0.069)}50%{-webkit-transform:scale3d(1.25,1.25,1.25); transform:scale3d(1.25,1.25,1.25)}
to{-webkit-transform:scale3d(0.069,0.069,0.069); transform:scale3d(0.069,0.069,0.069)}}
@keyframes pulse{from{-webkit-transform:scale3d(0.069,0.069,0.069); transform:scale3d(0.069,0.069,0.069)}50%{-webkit-transform:scale3d(1.25,1.25,1.25); transform:scale3d(1.25,1.25,1.25)}
to{-webkit-transform:scale3d(0.069,0.069,0.069);transform:scale3d(0.069,0.069,0.069)}}
.animation-pulse {-webkit-animation-name:pulse; animation-name:pulse}
</style>
<!-- End code -->
<style>
  .change-color {font-size:20px; font-weight:700; animation:myfirst 15s; -webkit-animation:myfirst 15s; animation-iteration-count:infinite; -webkit-animation-iteration-count:infinite}
@keyframes myfirst {
0% {color:hsl(5,96%,69%)}
...
<style>
  .comments .comments-content .icon.blog-author:before{content:"\f00c";font-family:fontawesome;background:#5890ff;border:2px solid #fff;position:relative;top:5px;right:6px;margin:0;display:block;color:#fff;border-radius:50%;margin-left:3px;font-size:10px;font-weight:500!important;height:18px;line-height:19px;overflow:hidden;text-align:center;width:18px;}
</style>
<style>
  tml,body{cursor:url(https://i.imgur.com/gokYuDn.png),auto}
a:hover,li:hover,p:hover,.span:hover{cursor:url(https://i.imgur.com/LWKLEaa.png),auto}
</style>

<body>
    <b:if cond='data:blog.url == data:blog.homepageUrl'><!-- Start Page Loading -->
<style>
/*----------------------------------------
    Pre-loader
------------------------------------------*/
    ...
    <div class="wrapper-masthead">
      <div class="container">
        <header class="masthead clearfix">
          ...
          <div class="site-info">
            <h7 class="site-name"><a href="{{ site.baseurl }}/">{{ site.name }}</a></h7>
            <p class="site-description">{{ site.description }}</p>
          </div>

          <nav>
            <a href="{{ site.baseurl }}/">Blog</a>
            <a href="{{ site.baseurl }}/testing">Test</a>
...
button:hover a{color:#55579e!important;text-decoration:none!important}
button:hover{background:transparent}
button:before,button:after{content:'';position:absolute;top:0;right:0;height:2px;</pre>
