...
![image](https://i.postimg.cc/T1NYhSdR/a.png)
...
*Incremental Research*: Build on current body of work, incrementally. Ex: You can change a small part of an algorithm or you find some new interesting results.

*Fundamental Research*: Experimental or theoretical work performed to obtain new findings on the basis of observable facts, without prior consideration that it will result in any practical application or use. It’s the research that causes destruction. Ex: Albert Einstein’s Theory of General Relativity.
...
And to this Michelle said: ‘YOU ARE WHAT YOU TELL YOURSELF.DON’T HOLD YOURSELF BACK.’
...
Here’s the link to Michelle's Slides: [link](https://github.com/michelledaviest/talks/tree/master/Undergraduate%20Research)

Link to the video : [link](https://www.youtube.com/watch?v=W6yIKzHTNSE)
