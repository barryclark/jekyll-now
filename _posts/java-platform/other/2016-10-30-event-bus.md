...
Bu yazıda Google Guava kütüphanesinde bulunan bir yapıyı aktarmaya çalışacağım. Anlatmak istedğim mantık Event Bus mantığı, implementasyonunu ise Google Guava ile yapıyor olacağız.
