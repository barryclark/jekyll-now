...
Bu yazıda Google Guava kütüphanesinde ki bulunan bir yapıyı aktarmaya çalışacağım. Anlatman istedğim mantık Event Bus mantığı, implementasyonunu ise Google Guava ile yapıyor olacağız.
