---
title: Azure DevOps automatic association of test methods from code to Test Cases in Azure DevOps Test Plans.
author: Janusz Nowak
header:
  teaser: https://github.com/JanuszNowak/janono.ado.testcase.associate.cli/raw/master/img/end2.png
