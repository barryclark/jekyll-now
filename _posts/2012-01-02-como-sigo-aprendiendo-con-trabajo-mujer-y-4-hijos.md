...
Si no me conoces, he pasado por muchos roles que necesitan habilidades y conocimientos diferentes.
...
Trabajamos en una profesión que aunque estés 2 años en un mismo rol y en una misma empresa, vas a necesitar adquirir nuevos conocimientos, herramientas, habilidades, etc.
...
- Como se hace esto es una de las grandes mágias de GTD y harían falta muchos posts para explicarlo todo. 
...
- Si abro el mail, leo como máximo el título de los 3 primeros artículos del mail de recomendación.
...
- ¿Esto quiere decir que cada día me levanto antes y en el desayuno leo libros? No, otros días leo algún árticulo, otros programo algo, muchos no hago nada... Depende del día, el tiempo que tenga y las ganas que tenga ese día de hacer algo.
...
- Tomo notas atómicas altamente enlazadas de todo lo que aprendo y Todoist no me sirve para hacerlo.
- Para las notas he tenido que crear  mi <a href="https://youtu.be/h9LfuVZquhg" target="_blank">cerebro digital</a>.
...
- Llevo unos meses cambiando a <a href="https://obsidian.md/" target="_blank">Obsidian</a> y poco a poco estoy migrando lo que tengo en OneNote. *(Sí, he probado Notion y no es lo que yo necesito)*
...
- Las principales razones para el cambio a Obsidian son:
	...
	- Tener control total sobre mis notas. 
...
- Aquí hay otro video que te puede ayudar a entenderlo de forma visual: <a href="https://www.youtube.com/watch?v=XsAKJLWunOM" target="_blank">Cómo tomar notas para siempre | Método Zettelkasten explicado con ejemplos visuales</a>.
...
- Intento seguir el siguiente proceso:
	...
	- Recopilo fuentes de información de esas partes (las miro en diagonal y si tienen buena pinta, a la Bandeja de Entrada)
...
- Tú práctica será utilizar de forma consciente alguno de los principios de escucha activa en la siguiente conversación que tengas con otra persona, ya sea tu pareja, tu hijo, un amigo o una persona de tu equipo si eres manager.
- Y cuando lo hayas practicado piensa en como lo podías haber hecho mejor y vas mejorando poco a poco.

## ¿Y cómo aprendendo en mi día a día haciendo con práctica deliberada si casi no tengo tiempo?
...
- Otra cosa que me funciona es proponerme explicar ese tema a otra persona o dar una charla o escribir sobre ello, ahí me obligo a tener fechas y a pensar muy bien que necesitas aprender para que lo puedas explicar a otras personas.

## ¿Cómo consigo aprender si solo tengo 15 minutos libres?
...
- Por ejemplo, si quiero aprender testing en legacy code:
  - En mis primeros huecos disponibles recupero posts o capítulos de libros que tengo sobre el tema. 
  ...
  - Por ejemplo si decido practicar "Approval Testing"
  - En los siguientes huecos busco ejemplos que podría implementar para practicar
...
- Las claves están en:
  ...
  - Ten siempre todo preparado suponiendo que solo vas a tener 15 minutos libres.
  ...
  - Seguro que en 15 minutos te da tiempo a practicar ese tipo de test que querías o esos atajos de teclado o ese refactor que no dominas.

- **Sumando pequeñas cosas y pequeños aprendizajes es cuando llegas a grandes cambios....**

## Resumen 
- Para aprender vas a necesitar motivación, pero la motivación se te va a acabar. En realidad necesitas tener mucha **fuerza de voluntad y constancia**.
...
- Parte del aprendizaje es organizar todo lo que has aprendido, ya sea código bien ordenado en GitHub, resumenes, notas bien estructuradas... Esto te ayudará a consolidar el aprendizaje y te permitirá consultar ese tema de forma muy rapida en un futuro.
