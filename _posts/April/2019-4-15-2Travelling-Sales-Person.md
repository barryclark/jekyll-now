...
I would love to do some more analysis, but instead I'll leave you with a standalone [file]() with the code, and the progression over the course of a 12 node graph and a `cutofflimit` 400,000 which is computed in less than a second on my computer.
