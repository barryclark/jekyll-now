...
Should I fork this open source project to add a feature that is only useful in my local context?
...
Llewellyn has another suggestion: if you need an open source project to do something new for your business, *_hire the owner_*. Pair with them. They are an expert in their code and the project vision, and can get things done quickly and effectively. And open source needs and deserves funding. 
