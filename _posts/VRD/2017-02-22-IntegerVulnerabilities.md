...
*Side Note: If a segmentation fault doesn't occur, the value that is being set will automatically wrap around not to a negative number but to a significantly higher number within the unsigned region. This is because malloc is expecting an unsigned value, in which the compiler can automatically allocate this*
#Conclusion
