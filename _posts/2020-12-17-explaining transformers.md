...
<figure>
    ...
    // console.log(window.location.pathname);
        require(['ecco', 'jquery'], (ecco, $) => {
            ...
            try{
                window.ecco['viz_hero_saliency'] = new ecco.MinimalHighlighter({
                    parentDiv:'viz_hero_saliency',
                    preset: 'viridis',
                    data: euHeroData
                    })
                window.ecco['viz_hero_saliency'].init()
                window.ecco['viz_hero_saliency'].selectFirstToken()
            } catch (err){
                showRefreshWarning();
