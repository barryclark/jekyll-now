...
A chaque nouveau projet web, nous devons disposer d’un « bagage de départ » en matière de bonnes pratiques, permettant de tenir compte de ces différents utilisateurs, contextes, profils et expériences. C’est l’objectif des <a href="https://checklists.opquast.com/fr/qualiteweb/">226 règles du référentiel Opquast pour la qualité web{% include external-icon.html %}</a>. Ces bonnes pratiques constituent une base, à partir de laquelle on peut ensuite se spécialer dans différentes branches de la qualité telles que l’accessibilité, l’ergonomie, le SEO...
...
<a href="https://www.opquast.com/certification/">La certification Opquast, maîtrise de la qualité en projet web{% include external-icon.html %}</a> s’adresse à tous les professionnels du web. Elle atteste de la capacité à maîtriser des risques qualité au sein d’un projet web et de communiquer efficacement à chaque étape de celui-ci avec les différents métiers impliqués.
...
- des conférences et meetups : ParisWeb, Kontinuum, Dev in Rodez...
- des articles de presse et des retours de certifiés publiés tout au long de l’année à l'image de l'article <a href="https://biig.fr/nous-sommes-inventifs/biigbox/opquast-objectif-qualite?utm_source=Social&amp;utm_medium=LinkedIn&amp;utm_content=opquast_26juin2019">Opquast, objectif qualité{% include external-icon.html %}</a> de François Thibaud, intégrateur chez Biig
- une newsletter publiée chaque mois
- <a href="https://www.drupal.org/project/opquast_checklist">un plugin drupal{% include external-icon.html %}</a> et <a href="https://fr.wordpress.org/plugins/quality-checklist-opquast/">un plugin wordpress{% include external-icon.html %}</a> pour faciliter la vérification et la mise en oeuvre des bonnes pratiques
- <a href="https://directory.opquast.com/fr/certifies/">un moteur de recherche des certifiés{% include external-icon.html %}</a>
- de nombreuses formations délivrées aux quatre coins de la France
- de nouveaux partenaires

## Opquast, une formation accessible ?
Pour ne pas perdre de vue l'accessibilité qui est au coeur de ce challenge #100daysofa11y, je vous propose un retour d'expérience d'<a href="https://twitter.com/eaboaf_" aria-label="Compte Twitter d'Emanuelle Aboaf">Emmanuelle Aboaf{% include external-icon.html %}</a>, développeuse sourde, et <a href="https://twitter.com/pierrereynaud" aria-label="Compte Twitter de Pierre Raynaud">Pierre Raynaud{% include external-icon.html %}</a>, non voyant, au sujet de l'accessibilité numérique de la plateforme de certification.
