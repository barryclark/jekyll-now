...
If you've been using one you like, stick with it, just as long as it doesn't get in the way of coding.The old industry favourite was [Sublime Text](https://www.sublimetext.com/3){:target="_blank"} and a few past WBDV grads loved [Brackets](http://brackets.io/){:target="_blank"}.

## Git
[Git](https://git-scm.com/){:target="_blank"} will be a large component of this program starting Sept 15th with CPNT 201. We will use Git to manage, share and deploy our code. It is the defacto industry standard for source control.
