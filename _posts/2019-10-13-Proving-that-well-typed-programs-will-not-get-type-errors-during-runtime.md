...
M is the result of applying a function {\xP} to a term Q. Since M has type {sigma}, then {\xP} must have type {tau -> sigma} (where tau is an arbitrary type) and Q must have type {tau}. 
...
Now that we have ![generation lemma result](https://latex.codecogs.com/gif.latex?%5CGamma%2C%20x%20%3A%20%5Ctau%20%5Cvdash%20P%20%3A%20%5Csigma) and ![q tau](https://latex.codecogs.com/gif.latex?%5CGamma%20%5Cvdash%20Q%20%3A%20%5Ctau)
