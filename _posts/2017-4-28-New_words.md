...
* hall of mirrors - 1. A carnival or amusement park attraction consisting of a maze or series of passageways lined with mirrors, especially curved mirrors giving distorted reflections.
...
j* elly scandal - [I was unable to find a definition of this word on the American Heritage Dictionary website]


* jiggy - 1. Moving excitedly, especially when dancing: getting jiggy on the dance floor.
...
* liminal - 1. Intermediate between two states, conditions, or regions; transitional or indeterminate: "While doctors operate, she hangs suspended in the liminal space between life and death" (Jeremy Eichler).
...
* nonperforming - 1. Performing poorly or unsatisfactorily: nonperforming schools.
...
* recursive - 1. Of or relating to a repeating process whose output at each stage is applied as input in the succeeding stage.
...
* tranche - 1. A portion of a total, especially of a block of assets such as cash or securities: the riskiest tranche of the bond offering; money delivered in two tranches.
...
* waterboard - 1. Sports Any of various boards, such as a kiteboard or wakeboard, used in waterboarding.
2. A board to which a person is attached when being subjected to waterboarding.

[Should that be waterboarding?]
...
* yellow dog - 1. A mean or contemptible person or thing.
...
* Zelig - 1. One who unconsciously mimics the traits or appearances of those with whom he or she associates.
...
* zettabyte - 1. A unit of computer memory or data storage capacity equal to 1,024 exabytes (270 bytes).
