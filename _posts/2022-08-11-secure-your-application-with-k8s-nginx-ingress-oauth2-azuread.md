...
Protecting resources behind a Kubernetes Ingress, is often NOT an easy task. Many application do not provide built-in authentication out-of-the-box.
Therefor, creating an awesome user experience, including a single sign on solution across all applications, can quickly become a tedious task.
...
You need to register an application in your Azure Active Directory. After registration you get all the useful information required in order to deploy oauth-proxy .
