---
layout: post
title: Tutorial: Creating a Deep Learning Heroku Python/Flask App on a Static Jekyll Site 
---
...
**Step 5: Set up GET and POST methods**
...
**Step 6: Run the Flask server locally to test**
