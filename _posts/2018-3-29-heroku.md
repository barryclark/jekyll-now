---
layout: post
title: Tutorial: Creating a Deep Learning Heroku Python/Flask App to use on a Static Jekyll Site 
---
...
```web: gunicorn app:app --log-file=-```
  Migrate over to the Git folder you created at the beginning of this tutorial, and create the Heroku app. This prepares Heroku to receive your code.
