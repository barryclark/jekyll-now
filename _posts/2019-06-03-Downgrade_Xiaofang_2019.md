...
Recently I have been looking into more and more Xiaomi devices and being pleasently suprised at every stage. The products are always great quality and so cheap. 
...
1. Format a microSD to Fat32 ( Mine was a 16gb one but I presume you could use less)
2. Download the firmware hosted [here](https://www102.zippyshare.com/v/OhOnBJg6/file.html). That filesharing site is blocked in the UK and maybe elsewhere so I have also hosted a download link [here](https://raw.githubusercontent.com/RemakingEden/mysite/master/downloads/xiaofang/demo.bin)
3. Copy the downloaded file "demo.bin" onto the sd card root (The very first page when opening the SD)
4. While the Xiafang camera is not plugged into power, insert the SD card
...
I hope this solved some issues. As I said in the guide it was not smooth and I cannot promise this will work for everyones 2019 Xiaofang block but It certainly worked for mine. Again thanks to junyang96 who wrote the original guide and translated from the Chinese site. 

Please drop me a message if you have any quesitons about this guide and I will try to help.
