...
알고리즘과 자료구조를 적용하지 않을 경우, 동일한 문제를 반복해서 해결해야 할 수 있으며 이는 자원 낭비로 이어질 수 있습니다. 더불어 코드를 보다 효율적으로 관리하고 유지보수하기 쉽게 만드는 데도 도움이 됩니다.
...
자료구조는 컴퓨터에서 데이터를 효과적으로 저장하고 조직하는 방법을 제공하는 데이터 요소 그룹으로 정의할 수 있습니다. 일반적인 자료구조의 예로는 배열, 링크드 리스트, 스택, 큐 등이 있습니다.
