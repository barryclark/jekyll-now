...
<input type="number" id="tax-225" min="0" readonly />
<input type="number" id="tax-25" min="0" readonly />
<input type="number" id="tax-025" min="0" readonly />
<input type="button" value="Calculate" id="addRowButton" />
