...
![_config.yml]({{ site.baseurl }}/images/Codebreaker/sqli_badstore/all_items.png)
...
![_config.yml]({{ site.baseurl }}/images/Codebreaker/sqli_badstore/version.png)
...
![_config.yml]({{ site.baseurl }}/images/Codebreaker/sqli_badstore/1s_returned.png)
...
![_config.yml]({{ site.baseurl }}/images/Codebreaker/sqli_badstore/form_length.png)
...
![_config.yml]({{ site.baseurl }}/images/Codebreaker/sqli_badstore/html_tags.png)
...
![_config.yml]({{ site.baseurl }}/images/Codebreaker/sqli_badstore/login_as_admin.png)
...
![_config.yml]({{ site.baseurl }}/images/Codebreaker/sqli_badstore/test_account.png)
...
![_config.yml]({{ site.baseurl }}/images/Codebreaker/sqli_badstore/supplier_login.png)
...
![_config.yml]({{ site.baseurl }}/images/Codebreaker/sqli_badstore/passwd_file.png)
...
![_config.yml]({{ site.baseurl }}/images/Codebreaker/sqli_badstore/cgi_file.png)
...
![_config.yml]({{ site.baseurl }}/images/Codebreaker/sqli_badstore/MySQL_username_passwd.png)

The username and password to the MySQL database is root and secret. 

![_config.yml]({{ site.baseurl }}/images/Codebreaker/sqli_badstore/secert_admin_portal.png)

There is a secret admin portal referenced in the code. 

![_config.yml]({{ site.baseurl }}/images/Codebreaker/sqli_badstore/cookie_format.png)
...
![_config.yml]({{ site.baseurl }}/images/Codebreaker/sqli_badstore/cart_cookie.png)
...
![_config.yml]({{ site.baseurl }}/images/Codebreaker/sqli_badstore/mysql_console.png)

The database can also be dumped using "mysqldump -h 192.168.126.135 -u root -p badstoredb > local_file"

![_config.yml]({{ site.baseurl }}/images/Codebreaker/sqli_badstore/database_dump.png)
