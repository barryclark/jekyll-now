 ...
 **Myers-Briggs Personality Type:** = ENFJ-A
 ...
 <center>![]({{site.baseurl}}//Screen%20Shot%202017-01-19%20at%2010.03.31%20AM.png)
...
## 2016-2017 Projects (Source Code Links)
  ...
  ✔ [**TipCalc**](https://github.com/emilypmendez/TipCalc)
  ...
  ✔ [**Balloon Tap**](https://github.com/emilypmendez/BalloonTap)
  
  -- Mobile app game via **the Lua language** built on **Corona SDK**
  
  
  
    
  ✔ [**Memory Keeper**](https://github.com/emilypmendez/MemoryKeeper)
  
  -- Mobile app built for reminders with **HTML, CSS, and Javascript**
    
    
  
  
  ✔ [**Priority App**](https://github.com/emilypmendez/PriorityApp)
  
  -- Time management app built with **Javascript and PHP**
  
  
  
  
  ✔ [**Login System**](https://github.com/emilypmendez/php-login)
