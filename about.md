...
I am looking for motivated Bioinformatics and Computer Science students interested in statistical modeling approaches to understand the genetics of complex traits to join our lab. Students need to have good communication (both oral and written) and organizational skills. Prior coursework in genetics/genomics, statistics, and programming is preferred. Familiarity or willingness to become familiar with Linux, R, and Python is required.

Undergraduate students working in my lab have to commit to at least 1.5 years and are expected to be in the lab 10-15 hours/week during the semester and if possible (funding is usually available) full-time during the summer. 
...
- What previous experience do you have with computer programming?
...
[hewlab15@gmail.com](mailto:hewlab15@gmail.com)
