...
#It doesn't seem like median values of 10 vs.10 were used. Calculating both, but mean matches paper fold changes much better (see last code block)

#List of peptides that were seem in both conditions (check this is right)
...
Correlate each sample with all other samples
```{r}
tmts_wide <- tmts %>% 
