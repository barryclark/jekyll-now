...
###The extras
Also, if you're further interested or wanted to use some of our data for some other reason, we have compiled a huge folder of as much data we ca pull, organized in a ton of different ways, to use as you please. You can find all that data [here](https://github.com/rsjudka/countVulgar/tree/master/data).
