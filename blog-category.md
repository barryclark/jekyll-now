...
<ul class="nav nav-tabs">
  <li class="active"><a data-toggle="tab" href="#java">Java EE&SE</a></li>
  <li><a data-toggle="tab" href="#spring">Spring</a></li>
  <li><a data-toggle="tab" href="#apache-guys">Apache Guys</a></li>
  <li class="dropdown">
    <a class="dropdown-toggle" data-toggle="dropdown" href="#android">Android<span class="caret"></span></a>
      <ul class="dropdown-menu">
        <li><a href="#android-tutorial">Android Tutorial</a></li>
        <li><a href="#android-oneri">Android Öneriler</a></li>
        <li><a href="#android-tt">Android Tips&Trick</a></li>
      </ul>
  </li>
