...
❕A follow-up article will detail how to use OpenCV with the Java Module System, ex. how to package ['OpenCV modules'](https://docs.opencv.org/master/) as Java Modules, how to use `jmod`, `jlink` and `jpackage`.
