---
layout: page
title: Ospitalità animali
permalink: /ospitalita_animali/
---
...
{% assign filteredissues = site.data.issuesjson | where: "state","open" | where_exp: "member","member.issue.labels contains 'Ospitalita animali'"%}
