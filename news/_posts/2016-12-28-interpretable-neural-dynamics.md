...
This model explicitly models the external stimulus interaction as locally linear, which means for any brain state we have a linear predictive model for how the stimulus will drive the brain state.
