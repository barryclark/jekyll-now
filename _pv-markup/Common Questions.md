...
1. [**Create an Account**](https://photovisionprints.squarespace.com/create-account) 
2. [**Submit Preference Images**](https://photovisionprints.squarespace.com/submit-preference-images)

## 2. Fill out an Order Form
Order forms are _**crucial**_. They help us ensure all your film has arrived safely and is processed to your specifications. Download + print one [here](https://photovisionprints.squarespace.com/s/PhotoVision-Film-Order-Form-Fall-2015.pdf).

## 3. Send in your Film + Order Form (*Safely*)
1. Learn how to [safely ship](https://photovisionprints.squarespace.com/shipping-tips) your precious cargo.
2. Download our [pre-addressed shipping label](http://static1.squarespace.com/static/525ad986e4b05804955f92b3/t/5283f921e4b05aa1b7657491/1384380705454/PhotoVision+Mailing+Label.pdf) or, if you prefer, hand-address your package in stunning calligraphy to:
**Attn: Film Crew**
**PhotoVision**
**3775 Market St NE**
**Salem, OR 97301**
...
**New customer?** First, [create an account](https://photovisionprints.squarespace.com/create-account). *Then*, [submit your preference images](https://photovisionprints.squarespace.com/submit-preference-images). 
**Current customers** may update preference images [here](https://photovisionprints.squarespace.com/submit-preference-images) or email them as an attachment to [info@photovisionprints.com](mailto:info@photovisionprints.com).
