...
The Java Platform Module System (JPMS), introduced in Java 9, adds [modularity to the Java platform](https://blogs.oracle.com/java/modular-development). With JPMS's [`jlink`](https://docs.oracle.com/en/java/javase/11/tools/jlink.html) it is now possible to create a custom Java Runtime that only carries the modules that are required by an application.
